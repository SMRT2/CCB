...
int64_t GetSporkValue(int nSporkID)
{
	...
	if (nSporkID == SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2) r = SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2_DEFAULT;
        if (nSporkID == SPORK_16_MN_WINNER_MINIMUM_AGE) r = SPORK_16_MN_WINNER_MINIMUM_AGE_DEFAULT;
	    //Coin Revival Spork
	if (nSporkID == SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT) r = SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
	...
	//Coin Revival Spork
    if (strName == "SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT") return SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
	...
	//Coin Revival Spork
    if (id == SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT) return "SPORK_17_REVIVAL_PAYMENT_ENFORCEMENT";
